...
def uNet1(first_dim,second_dim):
    ...
    f = [16, 32, 64, 128, 256]
    inputs = input_img = Input((first_dim, second_dim, 2))  #le due dimensioni devono essere potenze di 2!!  the two dimensions must be powers of 2!!!
    ...
    outputs = Convolution2D(2, (1, 1), padding="same", activation="sigmoid")(u4)
